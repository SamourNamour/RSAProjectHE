...
INSERT INTO `mebs_settings` VALUES (1,'BroadcasterID','513','The identifier of the broadcaster.','Y'),(2,'LastNotificationDate_Lock','2014-04-30 11:05:57',NULL,'N'),(3,'EventScheduler_SetLockValue_LastRun','2014-05-08 09:37:01',NULL,'N'),(4,'SchedulerTimeInterval','30',NULL,'Y'),(5,'DC_TimeBeforeLock','5',NULL,'Y'),(6,'DC_TimeInterval','16777215',NULL,'N'),(7,'DC_Inter_Package_Time_Gap','2',NULL,'Y'),(8,'DC_Time_Frame','5','','Y'),(9,'DC_User_Bitrate','3000000',NULL,'Y'),(10,'EventScheduler_SetIsExpiredValue_LastRun','2014-05-08 09:37:01',NULL,'N'),(11,'IngestedMedia_NLB_FTP_Relative_URI','/Contents/IngestedMedia/',NULL,'Y'),(12,'NLB_FTP_UserName','root',NULL,'Y'),(13,'NLB_FTP_UserPassword','televisio',NULL,'Y'),(14,'NLB_FTP_IPAddress','10.18.4.228','','Y'),(15,'DatacastCommand_Channel_Sending','6',NULL,'Y'),(16,'AR_Cover_Channel_Sending','1',NULL,'Y'),(17,'DC_Cover_Channel_Sending','D-check',NULL,'Y'),(18,'Interval_Cover_Sending','5',NULL,'Y'),(19,'DCCommand_Sending_Offset','-3','the offset to send the DCCommand','Y'),(20,'Categorization_Channel_Sending','0','','Y'),(21,'ExtendedAdv_Sending_Offset','D-Check','','Y'),(22,'DC_Inter_Command_Time_Gap','3',NULL,'Y'),(23,'Redundancy_BlockSize','279','Redundancy block Size (buffer size)','N'),(24,'Redundancy_RepetitionSpace','250','Redundancy repetition space','N'),(25,'Redundancy_RedundancyRate','0','Redundancy rate (Min 0|Max 100)','N'),(26,'LastVideoContentScheduledOn','2014-04-30 11:05:22',NULL,'N'),(27,'LastVideoContentRemovedOn','2014-04-14 12:41:09',NULL,'N'),(28,'FuturDCList_Channel_Sending','2','Channel used to send the Futur DC List XML','N'),(29,'LastCategoryItemsChangedOn','2014-04-14 12:41:09','Categories Notification','N'),(30,'LastVideoContentExpiredOn','2014-07-14 13:57:40','Expiration Notification','N');
...
/* Set The IsExpired value to true (1). */
  ...
  FETCH cur1 INTO IngestaId;
	IF(IngestaId > 0) THEN
		...
		UPDATE mebs_settings SET SettingValue = UTC_TIMESTAMP
		WHERE SettingName = 'LastVideoContentExpiredOn';
	END IF;
 END LOOP;
close cur1;
END ;;
