...
using MTV.EventDequeuer.Service.IOC;
    ...
    static class Program
    {
        ...
        public static string AppDataPath
        {
            get
            {
                if (_appdatapath != "")
                    return _appdatapath;
                _appdatapath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\MTV.EventBroker.Host\";
                return _appdatapath;
            }
        }
        ...
        static void Main()
        {
            ...
            IOCManager.Instance.Container.Install(new StandardIOCInstaller());
            ...
            try
            {
                ...
                LogManager.Log.InfoFormat("Initialising MTV.EventBroker.Service.Broker service in assembly {0} RELEASE windows service mode.", Assembly.GetExecutingAssembly().FullName);
